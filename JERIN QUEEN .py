...
from concurrent.futures import ThreadPoolExecutor as JERIN 
from string import * 
...
\033[1;37m------------------------------------------------
\033[1;37m Owner   : JERIN QUEEN         
\033[1;37m Facebook:  JÃŇŇÃT JERIN         
\033[1;37m Github  :  BLACK 1223456
...
def sarfraz():   
    ...
    if select =='1':
       ...
       cutter()
        ...
        os.system https://www.facebook.com/profile.php?id=61559258138028&mibextid=ZbWKwL
    else:
        print('\n Select valid option ... ')
        time.sleep(2)
        SSB(allkey)
...
def cutter():
    ...
    os.system('touch ' +JERIN)
    os.system('sort -r '+ssb+' | uniq > '+JERIN)
    os.system('clear')
    print(logo)
    print("Removed Successful From File : " + ssb )
    print(47*'-')
    print("File Saved To :" + JERIN )
    print(47*'-')
...
def cutter():
    ...
    ssb = input('Put File Name:')
    print(" ")
    JERIN = input('Saving Put File Name:')
    os.system('touch ' +JERIN)
    os.system('sort -r '+ssb+' | uniq > '+JERIN)
    os.system('clear')
    print(logo)
    print("Removed Successful From File: " + ssb )
    print("New File Saved:" + JERIN )
    print(47*'-')
    input(f"{S} Press Enter To Back SSB Menu ")
    SSB(allkey)       
